...
class TimeTableAdapterTest {
    ...
    fun setItemTest() {
        ...
        list.add(Session(1, "location", "11:11", 1, "title", null, null, null, null, false))
        list.add(Session(2, "location", "11:11", 1, "title", null, null, null, null, false))
        ...
        list.add(Session(3, "location3", "12:12", 2, "title", null, null, null, null, false))
        list.add(Session(4, "location4", "12:12", 2, "title", null, null, null, null, false))
